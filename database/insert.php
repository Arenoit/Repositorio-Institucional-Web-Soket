...
if($_SERVER["REQUEST_METHOD"]=='POST'){
    ...
    //insert projectos
    $result = mysqli_query($con,"INSERT INTO acaprojc(projc_mat_projc,projc_tit_projc,projc_fec_projc,projc_ubi_projc,projc_rem_projc,projc_cod_colec) VALUES ('$material','$titulo',$fecha,'$ubicacion','$resumen',(SELECT colec_cod_colec FROM acacolec WHERE colec_nom_colec='$coleccion'))");
    //insert tutor
